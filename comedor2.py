...
if rol == "admin":
    ...
    if st.session_state.informes == "📝 Informes PDF":
        ...
        # FORZAMOS LA LIMPIEZA PARA ASEGURARNOS
        st.cache_data.clear()

        # CARGA DIRECTA DE SUPABASE (Saltándonos la caché de db_select)
        with st.spinner("Cargando datos frescos de la nube..."):
            ...
            # Estas pueden seguir con db_select si no cambian mucho, 
            # pero por seguridad las pongo directas si quieres:
