...
if rol == "admin":
    ...
    if st.session_state.informes == "📝 Informes PDF":
        ...
        # --- FUNCIÓN CORREGIDA PARA EVITAR EL KEYERROR ---
        def obtener_defaults(fila_num):
            # Verificamos que el DataFrame no sea nulo y que las columnas existan
            ...
            return [] # Si hay error o está vacío, devolvemos lista vacía
